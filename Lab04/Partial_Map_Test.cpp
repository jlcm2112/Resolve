...
//  |*----------------------------------------------------------------*|
//  |   Date:    17 November 1997, revised 20 January 2008     
...
#include "CT/Partial_Map/Kernel_7_C.h"
...
concrete_instance
utility_class Natural_Are_In_Order_1 :
    implements
        abstract_instance General_Are_In_Order <Natural_Number_1_C>
{
public:
    ...
    utility_function_body Boolean Are_In_Order (
	    preserves Natural_Number_1_C& n1,
	    preserves Natural_Number_1_C& n2
	)
    {
...
class Partial_Map_Of_Natural_To_Text_Base :
    instantiates Partial_Map_Kernel_7_C <
	    Natural_Number_1_C,
            Text,
            Natural_Are_In_Order_1
	>
{};
